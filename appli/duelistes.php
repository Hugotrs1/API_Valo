...
$agents = json_decode(file_get_contents("http://localhost/API_VALO/API/agents/dueliste"), true);
            ...
            <div class="card mb-4">
                <div class="card-body d-flex">
                    <div>
                        ...
                        <p class="card-text">Nationalité: <?php echo htmlspecialchars($agent['nationalite']); ?></p>
